        ...
        <div className="min-h-[80vh] flex items-center justify-center px-4">
            ...
            >
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-500">Start booking world-class sports facilities</p>
                </div>
                ...
                <form onSubmit={handleSignup} className="space-y-6">
                    ...
                    <Button isLoading={loading} className="w-full h-12 text-lg">Create Account</Button>
                </form>

                <p className="text-center mt-6 text-slate-500">
                    Already have an account? <Link to="/auth/login" className="text-letsplay-blue font-bold hover:underline">Login</Link>
                </p>
            </motion.div>
        </div>
    );
